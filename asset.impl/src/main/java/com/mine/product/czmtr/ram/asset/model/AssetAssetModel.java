...
public class AssetAssetModel {
    ...
    @Column
    private double residualValue; //剩余价值
    @Column
    private double scrapValue; //残余价值
    @Column
    ...
    @Column
    private String oldUseDeptId; //原使用部门id
    @Column
    private String oldUserId; //原使用人id
    @Column
    ...
    @Column
    private String oldSavePlaceId; //原具体位置id（ex存放地点）
    @Column
    ...
    @Column
    private ASSET_STATUS beforeChangeAssetStatus; //变更前资产状态
    @Column
...
//        设置闲置时间
        if (assetStatus == ASSET_STATUS.闲置) {
            this.deActiveTime = Calendar.getInstance().getTime();
        }
    }
    ...
    public String getOldUseDeptId() {
        return oldUseDeptId;
    }

    public void setOldUseDeptId(String oldUseDeptId) {
        this.oldUseDeptId = oldUseDeptId;
    }
    ...
    public ASSET_STATUS getBeforeChangeAssetStatus() {
        return beforeChangeAssetStatus;
    }

    public void setBeforeChangeAssetStatus(ASSET_STATUS beforeChangeAssetStatus) {
    ...
    public void setIsSysn(boolean sysn) {
        isSysn = sysn;
    }
