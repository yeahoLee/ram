...
public class AssetReceiveUseTempDto implements Serializable {

    private String id;

    private String assetReceiveUseID;//资产借用主表ID

    private String assetReceiveRevertID;//资产归还主表ID

    private String savePlaceId;//使用位置ID(即领用位置)
    ...
    private String revertSavePlaceId;//归还位置
...
//基本信息End
    ...
    public String getAssetReceiveUseID() {
        return assetReceiveUseID;
    }

    public void setAssetReceiveUseID(String assetReceiveUseID) {
        this.assetReceiveUseID = assetReceiveUseID;
    }

    public String getAssetReceiveRevertID() {
        return assetReceiveRevertID;
    }

    public void setAssetReceiveRevertID(String assetReceiveRevertID) {
        this.assetReceiveRevertID = assetReceiveRevertID;
    }
