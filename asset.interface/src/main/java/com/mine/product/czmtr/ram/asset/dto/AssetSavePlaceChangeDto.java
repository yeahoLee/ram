...
public class AssetSavePlaceChangeDto implements Serializable {
    private String id;
    private String oldAssetSavePlaceId;//原资产安装位置ID
    private String oldAssetSavePlaceStr;
    private String assetSavePlaceId;//新资产安装位置ID
    private String assetSavePlaceStr;
    ...
    private List<String> assetIdList;// 支出ID list
    ...
    public String getOldAssetSavePlaceStr() {
        return oldAssetSavePlaceStr;
    }

    public void setOldAssetSavePlaceStr(String oldAssetSavePlaceStr) {
        this.oldAssetSavePlaceStr = oldAssetSavePlaceStr;
    }
    ...
    public String getAssetSavePlaceStr() {
        return assetSavePlaceStr;
    }

    public void setAssetSavePlaceStr(String assetSavePlaceStr) {
        this.assetSavePlaceStr = assetSavePlaceStr;
    }
