...
<head>
    ...
    <script type="text/javascript" src="resources/js/base/baseDeptIndex.js"></script>
...
<div id="deptUserListDialog" title="人员设置" class="easyui-dialog" data-options="width:400, height:395, closed:true">
    ...
    <div id="permUserDataGridTableButtons">
        <button class="btn btn-primary" onClick="$('#addUserToDeptDialog').dialog('center').dialog('open');"
