...
function saveChangeSavePlace(type) {
    ...
    $.ajax({
        url: 'assetChange/save_change_savePlace',
        type: 'POST',
        data: {
...
function saveAndCheckChangeSavePlace() {
    var assetSavePlaceId = $('#assetSavePlaceId').val();
    var reason = $('#reason').val();
    var assetIdListStr = $('#assetList input[name="assetIdList"]').val();
    $.ajax({
        url: 'assetChange/save_and_check_change_savePlace',
        type: 'POST',
        data: {
            assetSavePlaceId: assetSavePlaceId,
            reason: reason,
