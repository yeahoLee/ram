...
<head>
    ...
    <script type="text/javascript" src="resources/js/asset/assetUsabilityHistoryList.js"></script>
    ...
    <div data-options="region:'north',border:false">
        <div class="container-fluid">
            <div class="row" style="margin-top: 5px;">
                <div id="searchQuerys" class="col-lg-12 col-md-12 col-sm-12" style="height: 65px;">
