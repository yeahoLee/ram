...
<head>
    ...
    <script type="text/javascript" src="resources/js/asset/assetBorrowUpdate.js"></script>
...
<input id="type" value="${AssetBorrowDto.produceTypeStr }" type="hidden"/>
...
<input id="assetborrowDepartment" value="${AssetBorrowDto.assetborrowDepartmentID }" type="hidden"/>
<input id="assetborrowUser" value="${AssetBorrowDto.assetborrowUserID }" type="hidden"/>
<div style="height:50px;width:100%;padding-top:0px;padding-left:10px;text-align:left;position:fixed;top:0px;left:0px;background:white;z-index:9999">
    <button id="saveBtn" class="btn btn-primary" style="margin-right: 5px;" onclick="updateAssetBorrowSubmit();">
...
<%--            onclick="SaveAndSendAssetBorrowSubmit();">--%>
    ...
    <div class="container-fluid">
        ...
        <div class="row" style="margin-top: 5px;">
            <div class="col-lg-4 col-md-6 col-sm-6">
                ...
                <input id="revertTime" class="easyui-datebox" value="${AssetBorrowDto.revertTime }"/>
            </div>
        ...
        <div class="row" style="height:65px;">
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <textarea id="reason" class="textbox"
                          style="width:80%;height:60px;resize: none;">${AssetBorrowDto.reason }</textarea>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container-fluid">
        <div>
            <button id="saveBtn" class="btn btn-primary" style="margin-right: 5px;"
                    onclick="$('#assetListDialog').dialog('center').dialog('open');">
