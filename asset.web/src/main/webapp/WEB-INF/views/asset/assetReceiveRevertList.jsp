...
<head>
    ...
    <script type="text/javascript" src="resources/js/asset/assetReceiveRevertList.js"></script>
            ...
            <div class="row" style="margin-top: 5px;">
                <div id="searchQuerys" class="col-lg-12 col-md-12 col-sm-12" style="height: 40px;">
                    <div style="float:left; margin-top: 5px;">
                        ...
                        归还人： <input id="assetReceiveRevertUserID" class="easyui-combobox"
                                    data-options="url:'base/user_combo', mode: 'remote', method:'POST'"/>
                        归还日期： <input id="realrevertTimeStart" class="easyui-datebox"/>&nbsp;&nbsp;~&nbsp;&nbsp;<input
                            id="realrevertTimeEnd" class="easyui-datebox"/>
                    </div>
...
<!--将按钮放入datagrid中  -->
<div id="btdiv">
    <!-- 	<button class="btn btn-primary" onclick="goToAssetReceiveUsePage();" style="margin-top: 4px; margin-left: 5px; margin-right: 5px; margin-bottom:5px;"> -->
    <!-- 		<i class="fa fa-plus align-top bigger-125" style="margin-right: 5px;"></i>资产领用 -->
    <!-- 	</button> -->
    <button class="btn btn-primary" onclick="goToAssetReceiveRevertPage();"
