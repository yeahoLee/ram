...
<html>
<head>
    <title>资产管理员变更申请单</title>
    <jsp:include page="../libInclude.jsp"></jsp:include>
    <script type="text/javascript" src="resources/js/asset/assetManagerChange.js"></script>
...
<div style="height:50px;width:100%;padding-top:0px;padding-left:10px;text-align:left;position:fixed;top:0px;left:0px;background:white;z-index:9999">
    <button id="saveBtn" class="btn btn-primary" style="margin-right: 5px;" onclick="saveChangeManager(1);">
    ...
    <button id="saveandsendBtn" class="btn btn-primary" style="margin-right: 5px;"
            onclick="saveChangeManager(2);">
        <i class="fa fa-save align-top bigger-125" style="margin-right: 5px;"></i>保存并发起审批
    </button>
    <button class="btn btn-primary" onclick="location='./asset_maneger_change_receiptList'">
        ...
        <div class="row" style="margin-top: 5px;">
            <div class="col-lg-4 col-md-5 col-sm-6">
                <div class="gray"><span class="span-red-start">*</span><i class="fa fa-user"
                                                                          style="margin-right: 5px;"></i>原资产管理员：
                </div>
                ${userInfoDto.chsName}
                <input id="oldAssetManagerId" name="oldAssetManagerId" value="${userInfoDto.id}" type="hidden"/>
            </div>
            <div class="col-lg-4 col-md-5 col-sm-6">
                <div class="gray"><span class="span-red-start">*</span><i class="fa fa-user"
                                                                          style="margin-right: 5px;"></i>新资产管理员：
                </div>
