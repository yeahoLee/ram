...
<head>
    ...
    <script type="text/javascript" src="resources/js/asset/assetReceiveRevertUpdate.js"></script>
...
<input id="type" value="${AssetReceiveRevertDto.produceTypeStr }" type="hidden"/>>
...
<input id="assetReceiveRevertDepartment" value="${AssetReceiveRevertDto.assetReceiveRevertDepartmentID }"
       type="hidden"/>
<input id="assetReceiveRevertUser" value="${AssetReceiveRevertDto.assetReceiveRevertUserID }" type="hidden"/>
<div style="height:50px;width:100%;padding-top:0px;padding-left:10px;text-align:left;position:fixed;top:0px;left:0px;background:white;z-index:9999">
    <button id="saveBtn" class="btn btn-primary" style="margin-right: 5px;" onclick="updateAssetReceiveRevertSubmit();">
...
<%--            onclick="SaveAndSendAssetReceiveRevertSubmit();">--%>
    ...
    <div class="container-fluid">
        <div class="row" style="margin-top: 5px;">
            <div class="col-lg-4 col-md-5 col-sm-6">
                <div class="gray"><span class="span-red-start">*</span><i class="fa fa-random"
                                                                          style="margin-right: 5px;"></i>归还部门：
                </div>
                <input id="assetReceiveRevertDepartmentID" class="easyui-combotree"/>
            </div>
            <div class="col-lg-4 col-md-5 col-sm-6">
                <div class="gray"><span class="span-red-start">*</span><i class="fa fa-list-ol"
                                                                          style="margin-right: 5px;"></i>归还人：
                </div>
                <input id="assetReceiveRevertUserID" class="easyui-combobox"/>
            </div>
        </div>
        <div class="row" style="margin-top: 5px;">
            <div class="col-lg-4 col-md-5 col-sm-6">
                <div class="gray"><span class="span-red-start">*</span><i class="fa fa-table"></i>归还日期：</div>
                <input id="realrevertTime" class="easyui-datebox" value="${AssetReceiveRevertDto.realrevertTime }"/>
            </div>
        ...
        <div class="row" style="height:65px;">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="gray" style="height:60px;"><i class="fa fa-flag" style="margin-right: 5px;"></i>借用事由：</div>
                <textarea id="remarks" class="textbox"
                          style="width:80%;height:60px;resize: none;">${AssetReceiveRevertDto.remarks }</textarea>
            </div>
        </div>
    </div>
</div>
<div id="assetList" style="margin-top: 5px;">
    ...
    <div class="container-fluid">
        <div>
            ...
            <button id="saveBtn" class="btn btn-primary" style="margin-right: 10px;"
                    onclick="openDialogForSavePlace();">
                <i class="fa fa-plus align-top bigger-125" style="margin-right: 5px;"></i>变更归还位置
            </button>
        </div>
...
<!-- 变更使用位置 -->
<div id="instSiteCodeDialog" class="easyui-dialog" title="添加使用位置" data-options="width:880, height:435, closed: true">
