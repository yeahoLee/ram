...
<head>
    ...
    <script type="text/javascript" src="resources/js/asset/assetReceiveUseUpdate.js"></script>
...
<input id="AssetReceiveUserID" value="${AssetReceiveUseDto.assetReceiveUseUserID }" type="hidden"/>
<input id="type" value="${AssetReceiveUseDto.produceTypeStr }" type="hidden"/>
...
<input id="assetReceiveUseUser" value="${AssetReceiveUseDto.assetReceiveUseUserID }" type="hidden"/>
<input id="assetReceiveUseDepartment" value="${AssetReceiveUseDto.assetReceiveUseDepartmentID }" type="hidden"/>
<div style="height:50px;width:100%;padding-top:0px;padding-left:10px;text-align:left;position:fixed;top:0px;left:0px;background:white;z-index:9999">
    <button id="saveBtn" class="btn btn-primary" style="margin-right: 5px;" onclick="updateAssetReceiveUserSubmit();">
...
<%--            onclick="SaveAndSendAssetReceiveUseSubmit();">--%>
        ...
        <div class="row" style="margin-top: 5px;">
            <div class="col-lg-4 col-md-5 col-sm-6">
                <div class="gray"><span class="span-red-start">*</span><i class="fa fa-random"
                                                                          style="margin-right: 5px;"></i>领用部门：
                </div>
                <input id="assetReceiveUseDepartmentID" class="easyui-combotree"/>
            </div>
            <div class="col-lg-4 col-md-5 col-sm-6">
                <div class="gray"><span class="span-red-start">*</span><i class="fa fa-list-ol"
                                                                          style="margin-right: 5px;"></i>领用人：
                </div>
                <input id="assetReceiveUseUserID" class="easyui-combobox"/>
            </div>
        </div>
        <div class="row" style="margin-top: 5px;">
        ...
        <div class="row" style="height:65px;">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="gray" style="height:60px;"><span class="span-red-start">*</span><i class="fa fa-flag"
                                                                                               style="margin-right: 5px;"></i>领用事由：
                </div>
                <textarea id="reason" class="textbox"
                          style="width:80%;height:60px;resize: none;">${AssetReceiveUseDto.reason }</textarea>
            </div>
        </div>
    </div>
</div>
