...
<head>
    ...
    <script type="text/javascript" src="resources/js/asset/assetUnsealUpdate.js"></script>
...
<input id="type" value="${assetSeal.produceTypeStr }" type="hidden"/>
...
<div style="height:50px;width:100%;padding-top:0px;padding-left:10px;text-align:left;position:fixed;top:0px;left:0px;background:white;z-index:9999">
    ...
    <!-- <button id="saveBtn" class="btn btn-primary" style="margin-right: 5px;" onclick="saveAndCheckSeal();">
...
<div id="headTitle" align="center" style="font-weight:blod;font-size:20px;padding:5px;margin-top:50px;"></div>
    ...
    <div class="container-fluid">
        <div class="row" style="height:65px;">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="gray" style="height:60px;"><span class="span-red-start">*</span><i id="reasonHtml" class="fa fa-flag"
...
<div id="assetList" style="margin-top: 60px;">
    <span class="span-title" id="ooo"></span>
    <hr class="hr-css"/>
    <div class="container-fluid">
        <div>
