...
<html>
<head>
    <title>编辑资产减损申请单</title>
    <jsp:include page="../libInclude.jsp"></jsp:include>
    <script type="text/javascript" src="resources/js/asset/assetReduceUpdate.js"></script>
...
<div style="height:50px;width:100%;padding-top:0px;padding-left:10px;text-align:left;position:fixed;top:0px;left:0px;background:white;z-index:9999">
    <button id="saveBtn" class="btn btn-primary" style="margin-right: 5px;" onclick="update();">
        <i class="fa fa-save align-top bigger-125" style="margin-right: 5px;"></i>保存
    </button>
    <button class="btn btn-primary" style="margin-left: 5px;" onclick="location='./asset_reduce_list'">
        <i class="fa fa-angle-left" style="margin-right: 5px;"></i>返回
    </button>
</div>
<input id="AssetReduceId" value="${AssetReduceDto.id}" type="hidden">
<input id="type" value="${AssetReduceDto.produceTypeStr }" type="hidden"/>
    ...
    <div class="container-fluid">
        <div class="row" style="margin-top: 5px;">
            <div class="col-lg-4 col-md-5 col-sm-6">
                ...
                <input id="orderName" name="orderName" type="text" class="textbox" value="${AssetReduceDto.orderName}">
            </div>
            <div class="col-lg-4 col-md-5 col-sm-6">
                <div class="gray"><span class="span-red-start">*</span><i class="fa fa-dropbox"></i>资产减损类型：</div>
                <input id="reduceType" name="reduceType" class="easyui-combobox" value="${AssetReduceDto.reduceType}"
                       data-options="url:'ram/enum_combo?moduleName=ram.asset.service.IAssetService&methodName=REDUCE_TYPE', method:'GET', editable:false,disabled:true"/>
            </div>
        </div>
        <div class="row" style="margin-top: 5px;">
            <div class="col-lg-4 col-md-5 col-sm-6">
                ...
                未知
                <input id="surplusValue" name="surplusValue" type="hidden" value="${AssetReduceDto.surplusValue}"/>
            </div>
        ...
        <div class="row" style="margin-top: 5px;">
            <div class="col-lg-4 col-md-5 col-sm-6">
                ...
                <input id="processingCost" name="processingCost" type="number" class="textbox" min="0"
                       value="${AssetReduceDto.processingCost}">
            </div>
            <div class="col-lg-4 col-md-5 col-sm-6">
                ...
                <input id="actualLoss" name="actualLoss" type="number" class="textbox" min="0"
                       value="${AssetReduceDto.actualLoss}">
            </div>
        </div>
        <div class="row" style="height:65px;">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="gray" style="height:60px;"><span class="span-red-start">*</span><i class="fa fa-line-chart"
                                                                                               style="margin-right: 5px;"></i>减损原因：
                </div>
                <textarea id="reason" class="textbox"
                          style="width:80%;height:60px;resize: none;">${AssetReduceDto.reason}</textarea>
            </div>
        </div>
        <div class="row" style="height:65px;">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="gray" style="height:60px;"><span class="span-red-start">*</span><i class="fa fa-flag"
                                                                                               style="margin-right: 5px;"></i>拟处置办法：
                </div>
                <textarea id="proposedDisposal" class="textbox"
                          style="width:80%;height:60px;resize: none;">${AssetReduceDto.proposedDisposal}</textarea>
            </div>
        </div>
    </div>
</div>
