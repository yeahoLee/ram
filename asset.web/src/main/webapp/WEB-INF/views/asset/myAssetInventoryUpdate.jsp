...
<head>
    ...
    <script type="text/javascript" src="resources/js/asset/myAssetInventoryUpdate.js"></script>
...
<input id="produceType" value="${myAssetInventoryDto.produceTypeStr }" type="hidden"/>
...
<div id="baseInfo" style="margin-top: 45px;">
    ...
    <div>
        <table class="table table-bordered" style="margin-bottom: 0px;">
            <tr>
                ...
                <td id="inventoryName" class="td" style="width: 25%;" colspan="3">${assetInventoryDto.inventoryName }</td>
            ...
            <tr>
                ...
                <td id="myAssetInventoryCode" class="td">${myAssetInventoryDto.myAssetInventoryCode }</td>
    ...
    <div id="assetInventoryTempDialog" class="easyui-dialog" title="填写盘点结果"
         data-options="closed:true, width:680,height:200, buttons:'#assetInventoryTempDialogButtons'">
        <div class="container-fluid">
