...
<head>
    ...
    <script type="text/javascript" src="resources/js/asset/assetRevertUpdate.js"></script>
...
<input id="type" value="${AssetRevertDto.produceTypeStr }" type="hidden"/>
...
<input id="assetrevertUser" value="${AssetRevertDto.assetrevertUserID2}" type="hidden"/>
<input id="assetrevertDepartment" value="${AssetRevertDto.assetrevertDepartmentID }" type="hidden"/>
<div style="height:50px;width:100%;padding-top:0px;padding-left:10px;text-align:left;position:fixed;top:0px;left:0px;background:white;z-index:9999">
    <button id="saveBtn" class="btn btn-primary" style="margin-right: 5px;" onclick="updateAssetRevertSubmit();">
...
<%--            onclick="SaveAndSendAssetRevertSubmit();">--%>
    ...
    <div class="container-fluid">
        <div class="row" style="margin-top: 5px;">
            <div class="col-lg-4 col-md-5 col-sm-6">
                ...
                <select id="assetrevertDepartmentID" class="easyui-combotree"></select>
            </div>
            <div class="col-lg-4 col-md-5 col-sm-6">
                <div class="gray"><span class="span-red-start">*</span><i class="fa fa-list-ol"
                                                                          style="margin-right: 5px;"></i>归还人：
                </div>
                <input id="assetrevertUserID" class="easyui-combobox"/>
            </div>
        </div>
        <div class="row" style="margin-top: 5px;">
            <div class="col-lg-4 col-md-5 col-sm-6">
                <div class="gray"><span class="span-red-start">*</span><i class="fa fa-table"></i>归还日期：</div>
                <input id="realrevertTime" class="easyui-datebox" value="${AssetRevertDto.realrevertTime }"/>
            </div>
        ...
        <div class="row" style="height:65px;">
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <textarea id="remarks" class="textbox"
                          style="width:80%;height:60px;resize: none;">${AssetRevertDto.remarks }</textarea>
            </div>
        </div>
    </div>
</div>
...
<!-- 变更使用位置 -->
<div id="instSiteCodeDialog" class="easyui-dialog" title="添加使用位置" data-options="width:880, height:435, closed: false">
