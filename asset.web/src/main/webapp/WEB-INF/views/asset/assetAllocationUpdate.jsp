...
<head>
    ...
    <script type="text/javascript" src="resources/js/asset/assetAllocationUpdate.js"></script>
...
<body>
<input id="type" value="${AssetAllocationDto.produceTypeStr }" type="hidden"/>
...
<input id="callInDepartment" value="${AssetAllocationDto.callInDepartmentId }" type="hidden"/>
<input id="callInAssetManager" value="${AssetAllocationDto.callInAssetManagerId }" type="hidden"/>
<div style="height:50px;width:100%;padding-top:0px;padding-left:10px;text-align:left;position:fixed;top:0px;left:0px;background:white;z-index:9999">
    <button id="saveBtn" class="btn btn-primary" style="margin-right: 5px;" onclick="updateAssetAllocationSubmit();">
...
<%--            onclick="SaveAndSendAssetAllocationSubmit();">--%>
        ...
        <div class="row" style="margin-top: 5px;">
            <div class="col-lg-4 col-md-6 col-sm-6">
                ...
                <input id="callOutDepartmentId" class="easyui-combotree"
                       data-options=" url: 'base/get_dept_tree',value:'${AssetAllocationDto.callOutDepartmentId}', method:'POST'"/>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="gray" style="width:180px;"><span class="span-red-start">*</span><i class="fa fa-random"
                ...
                <input id="callInDepartmentId" class="easyui-combotree"
                       data-options=" url: 'base/get_dept_tree',value:'${AssetAllocationDto.callInDepartmentId}', method:'POST'"/>
            </div>
        </div>
        <div class="row" style="margin-top: 5px;">
            <div class="col-lg-4 col-md-6 col-sm-6">
                ...
                <input id="callInAssetManagerId" class="easyui-combobox"
                       data-options="url:'base/perm_user_datagrid_code?code=zcgly', mode: 'remote',value:'${AssetAllocationDto.callInAssetManagerId}', method:'POST'"/>
            </div>
            ...
            <div class="col-lg-8 col-md-8 col-sm-6">
                <div class="gray" style="width:180px;"><i class="fa fa-server"></i>调入位置：</div>
                <div class="gray" style="width:450px; text-align: left; padding-left: 15px; background-color: white;">
                    <span id="showCodeAndData"
                          style="position:relative;left:-15px">${AssetAllocationDto.callInSavePlaceId!=null?AssetAllocationDto.callInSavePlaceStr:'保持现有位置(默认)' }</span>&nbsp;&nbsp;&nbsp;&nbsp;
                    <a onclick="openDialogForSavePlace();" style="padding-right: 15px;">选择位置</a>
                    <input id="callInSavePlaceIdHidden" name="callInSavePlaceIdHidden"
                           value="${AssetAllocationDto.callInSavePlaceId }" type="hidden">
                </div>
            </div>
        </div>
        <div class="row" style="height:65px;">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="gray" style="height:60px;width:180px;"><span class="span-red-start">*</span><i
                        class="fa fa-flag" style="margin-right: 5px;"></i>调拨原因：
                </div>
                <textarea id="reason" class="textbox"
                          style="width:80%;height:60px;resize: none;">${AssetAllocationDto.reason }</textarea>
            </div>
        </div>
    </div>
</div>
...
<!-- 变更使用位置 -->
<div id="instSiteCodeDialog" class=
        "easyui-dialog" title="添加调入位置" data-options="width:880, height:435, closed: false">
