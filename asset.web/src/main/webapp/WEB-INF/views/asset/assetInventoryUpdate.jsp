...
<head>
    ...
    <script type="text/javascript" src="resources/js/asset/assetInventoryUpdate.js"></script>
        ...
        <div class="row" style="margin-top: 5px;">
            <div class="col-lg-4 col-md-5 col-sm-6">
                ...
                <input id="inventoryName" name="inventoryName" type="text" class="textbox"
                       value="${assetInventoryDto.inventoryName}"/>
            </div>
        ...
        <div class="row" style="height:65px;">
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <textarea id="reason" class="textbox"
                          style="width:84%;height:60px;resize: none;">${assetInventoryDto.reason }</textarea>
            </div>
        </div>
    </div>
</div>
