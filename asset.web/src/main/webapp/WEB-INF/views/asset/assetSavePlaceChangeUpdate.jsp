...
<html>
<head>
    <title>编辑资产安装位置变更申请单</title>
    <jsp:include page="../libInclude.jsp"></jsp:include>
    <script type="text/javascript" src="resources/js/asset/assetSavePlaceChangeUpdate.js"></script>
...
<div style="height:50px;width:100%;padding-top:0px;padding-left:10px;text-align:left;position:fixed;top:0px;left:0px;background:white;z-index:9999">
    <button id="saveBtn" class="btn btn-primary" style="margin-right: 5px;" onclick="updateChangeSavePlace();">
        <i class="fa fa-save align-top bigger-125" style="margin-right: 5px;"></i>保存
    </button>
    <button class="btn btn-primary" style="margin-left: 5px;" onclick="location='./asset_savePlace_change_list'">
        <i class="fa fa-angle-left" style="margin-right: 5px;"></i>返回
    </button>
</div>
<input id="AssetSavePlaceChangeId" value="${AssetSavePlaceChangeDto.id}" type="hidden">
<input id="type" value="${AssetSavePlaceChangeDto.produceTypeStr }" type="hidden"/>
            ...
            <div class="col-lg-8 col-md-12 col-sm-6">
                ...
                <div class="gray" style="width:500px; text-align: left; padding-left: 15px; background-color: white;">
                    <span id="showCodeAndData"
                          style="position:relative;left:-15px">${AssetSavePlaceChangeDto.assetSavePlaceStr}</span>&nbsp;&nbsp;&nbsp;&nbsp;
                    <a onclick="openDialig();" style="padding-right: 15px;">选择位置</a>
                    <input id="assetSavePlaceId" name="asseSavePlaceId" type="hidden"
                           value="${AssetSavePlaceChangeDto.assetSavePlaceId}">
                </div>
            </div>
        ...
        <div class="row" style="height:65px;">
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <textarea id="reason" class="textbox"
                          style="width:80%;height:60px;resize: none;">${AssetSavePlaceChangeDto.reason}</textarea>
            </div>
        </div>
    </div>
</div>
<div id="assetList" style="margin-top: 5px;">
    <input id="assetIdList" name="assetIdList" type="hidden" value="${AssetSavePlaceChangeDto.assetIdListStr }"/>
