...
<head>
    ...
    <script type="text/javascript" src="resources/js/asset/assetReceiveRevertCreate.js"></script>
...
<div style="height:50px;width:100%;padding-top:0px;padding-left:10px;text-align:left;position:fixed;top:0px;left:0px;background:white;z-index:9999">
    <button id="saveBtn" class="btn btn-primary" style="margin-right: 5px;" onclick="saveAssetReceiveRevertSubmit(1);">
    ...
    <button id="saveandsendBtn" class="btn btn-primary" style="margin-right: 5px;"
            onclick="saveAssetReceiveRevertSubmit(2);">
    ...
    <div class="container-fluid">
        <div class="row" style="margin-top: 5px;">
            ...
            <!-- <div class="col-lg-4 col-md-4 col-sm-6">
               ...
               <input id="realrevertTime" class="easyui-datebox" />
           </div> -->
        </div>
        <div class="row" style="margin-top: 5px;">
            <div class="col-lg-4 col-md-5 col-sm-6">
...
<div id="assetList" style="margin-top: 5px;">
    ...
    <div class="container-fluid">
        <div>
            ...
            <button id="saveBtn" class="btn btn-primary" style="margin-right: 5px;" onclick="openDialogForSavePlace();">
