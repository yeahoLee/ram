...
<head>
    ...
    <script type="text/javascript" src="resources/js/asset/assetReceiveUseCreate.js"></script>
...
<div style="height:50px;width:100%;padding-top:0px;padding-left:10px;text-align:left;position:fixed;top:0px;left:0px;background:white;z-index:9999">
    <button id="saveBtn" class="btn btn-primary" style="margin-right: 5px;" onclick="saveAssetReceiveUseSubmit(1);">
    ...
    <button id="saveandsendBtn" class="btn btn-primary" style="margin-right: 5px;"
            onclick="saveAssetReceiveUseSubmit(2);">
