...
<head>
    ...
    <script type="text/javascript" src="resources/js/asset/assetSequestrationSeal.js"></script>
    ...
    <div class="container-fluid">
        <div class="row" style="margin-top: 5px;">
            <div class="col-lg-8 col-md-12 col-sm-6">
                <div class="gray" style="height:60px;"><span class="span-red-start">*</span><i class="fa fa-server"
