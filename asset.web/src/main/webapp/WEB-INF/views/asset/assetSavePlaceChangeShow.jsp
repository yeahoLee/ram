...
<html>
<head>
    <title>查看资产安装位置变更申请单</title>
    <jsp:include page="../libInclude.jsp"></jsp:include>
    <script type="text/javascript" src="resources/js/asset/assetSavePlaceChangeShow.js"></script>
    ...
    <div class="container-fluid">
        <table class="baseInfo" style="border:1px solid gray;width:100%;">
            <tr>
                ...
                <td>${AssetSavePlaceChangeDto.changeNum}</td>
                <td class="tdColor">发起日期</td>
                <td>${AssetSavePlaceChangeDto.createTimestamp}</td>
                <td class="tdColor">发起人</td>
                <td>${AssetSavePlaceChangeDto.createUserIdStr}</td>
                <td class="tdColor">审核状态</td>
                <td>${AssetSavePlaceChangeDto.receiptStatusStr}</td>
            </tr>
            <tr>
                <td class="tdColor">目标位置</td>
                <td colspan="7" style="text-align:left;">${AssetSavePlaceChangeDto.assetSavePlaceStr}</td>
            </tr>
            <tr>
                <td class="tdColor">变更原因</td>
                <td colspan="7" style="text-align:left;">${AssetSavePlaceChangeDto.reason}</td>
            </tr>
        </table>
    </div>
</div>
