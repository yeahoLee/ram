...
<head>
    ...
    <script type="text/javascript" src="resources/js/asset/assetUpdateManagerChangeReceipt.js"></script>
...
<div style="height:50px;width:100%;padding-top:0px;padding-left:10px;text-align:left;position:fixed;top:0px;left:0px;background:white;z-index:9999">
    <button id="saveBtn" class="btn btn-primary" style="margin-right: 5px;" onclick="updateChangeManager();">
        <i class="fa fa-save align-top bigger-125" style="margin-right: 5px;"></i>保存
    </button>
    <button class="btn btn-primary" style="margin-left: 5px;" onclick="location='./asset_maneger_change_receiptList'">
...
<input id="type" value="${AssetManagerChangeDto.produceTypeStr }" type="hidden"/>
    ...
    <div class="container-fluid">
        <div class="row" style="margin-top: 5px;">
            <div class="col-lg-4 col-md-5 col-sm-6">
                <div class="gray"><span class="span-red-start">*</span>原资产管理员：</div>
                ${AssetManagerChangeDto.oldAssetManagerStr}
                <input id="oldAssetManagerId" name="oldAssetManagerId" type="hidden"
                       value="${AssetManagerChangeDto.oldAssetManagerId}"/>
            </div>
            <div class="col-lg-4 col-md-5 col-sm-6">
                <div class="gray"><span class="span-red-start">*</span>新资产管理员：</div>
                <input id="assetManagerId" name="assetManagerId" class="easyui-combobox"
                       value="${AssetManagerChangeDto.assetManagerId}"
        ...
        <div class="row" style="height:65px;">
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <textarea id="reason" class="textbox"
                          style="width:80%;height:60px;resize: none;">${AssetManagerChangeDto.reason}</textarea>
            </div>
        </div>
    </div>
</div>
