...
<head>
    ...
    <script type="text/javascript" src="resources/js/asset/assetBorrowList.js"></script>
            ...
            <div class="row" style="margin-top: 5px;">
                <div id="searchQuerys" class="col-lg-12 col-md-12 col-sm-12" style="height: 40px;">
                    <div style="float:left; margin-top: 5px;">
                        ...
                        借用人： <input id="assetborrowUserID" class="easyui-combobox "
                                    data-options="url:'base/user_combo', mode: 'remote', method:'POST'"/>
                        借用日期： <input id="createTimestampStart" class="easyui-datebox "/> &nbsp;&nbsp;~&nbsp;&nbsp;
...
<!--将按钮放入datagrid中  -->
<div id="btdiv">
    <button class="btn btn-primary" onclick="goToAssetBorrowPage();"
    ...
    <!-- 	<button class="btn btn-primary" onclick="goToAssetRevertPage();" style="margin-top: 4px; margin-left: 5px; margin-right: 5px; margin-bottom:5px;"> -->
