...
<head>
    ...
    <script type="text/javascript" src="resources/js/asset/addMaterialReceipt.js"></script>
...
<div style="height:50px; width:100%; padding-top:0px; padding-left:10px; text-align:left; position:fixed; top:0px; left:0px; background:white;">
    <button id="sBtn" class="btn btn-primary" onclick="saveReceipt(1);" style="margin-right: 5px;">
        <i class="fa fa-save" style="margin-right: 5px;"></i>保存
    </button>
    <button id="ssBtn" class="btn btn-primary" onclick="saveReceipt(2);" style="margin-right: 5px;">
        <i class="fa fa-save" style="margin-right: 5px;"></i>保存并发起审批
    </button>
...
<div id="mateReceInfo" style="margin-top: 45px;">
    ...
    <div class="container-fluid">
        <div class="row" style="margin-top: 5px;">
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="gray" style="width:180px;"><span class="span-red-start">*</span><i
                        class="fa fa-list-alt"></i>资产新增单名称：
                </div>
                <input name="receiptName" class="textbox"/>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="gray" style="width:180px;"><span class="span-red-start">*</span><i
                ...
                <input id="sourceType" name="sourceType" class="easyui-combobox"
                       data-options="url:'ram/enum_combo_by_source_type', method:'GET', editable:false"/>
            </div>
        </div>
        <div class="row" style="margin-top: 5px;">
        ...
        <div class="row" style="height:65px;">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="gray" style="height:60px;width:180px;"><i class="fa fa-flag"></i>备注：</div>
    ...
    <hr class="hr-css"/>
    <div id="materialInfo" style="margin-top: 5px;">
        ...
        <div id="assetDataGridTableButtons">
            ...
            <button id="delBtn" class="btn btn-primary" onclick="deleteAsset()" style="margin-right:5px;">
...
<%--                        <input name="materialCode" id="materialCode" class="easyui-combobox"  />--%>
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-6">
                        <div class="gray"><i class="fa fa-dropbox"></i>资产类别：</div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="gray"><i class="fa fa-tint"></i>计量单位：</div>
                ...
                <div class="row" style="margin-top: 5px;">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        ...
                        <input id="belongLine" name="belongLine" class="easyui-combobox"
                               data-options="url:'base/common_combo?commonCodeType=BELONG_LINE&showCode=true',method:'POST'"/>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6">
